...
title: Sharing phase
phase: Share
tags: ["repository", "domain-specific repositories", "discipline-specific repositories", "general-purpose repositories", "restricted access", "institutional repositories", "cellular and molecular imaging data", "genomics data", "metabolomics and exposomics data", "proteomics data", "spatial omics data", "structural biology data"]
toc: True
---
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample8" role="button" aria-expanded="false" aria-controls="collapseExample8">
    KI Data Repository<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample8">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://kib.ki.se/en/publish-analyse/publish-and-share-research-data/doris-publish-and-share-your-research-data" target="_blank">
        <b>Visit KI Data Repository <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample5">
    KTH Data Repository<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample5">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://datarepository.kth.se" target="_blank">
        <b>Visit KTH Data Repository <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
  ...
  <div class="collapse" id="collapseExample9">
    <div class="card card-body">
      ...
      <a class="link-teal" href="https://zenodo.org/communities/kth/records?q=&l=list&p=1&s=10&sort=newest" target="_blank">
        <b>Visit KTH Zenodo community <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample10" role="button" aria-expanded="false" aria-controls="collapseExample10">
    SciLifeLab Data Repository<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample10">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://www.scilifelab.se/data/repository/" target="_blank">
        <b>Visit SciLifeLab Data Repository <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseExample11" href="#collapseExample11">
    Stockholm University Figshare<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample11">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://su.figshare.com/" target="_blank">
        <b>Visit Stockholm University Figshare <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample12" role="button" aria-expanded="false" aria-controls="collapseExample12">
    SND DORIS<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample12">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://snd.se/en/doris-researchers/describe-data-doris" target="_blank">
        <b>Visit DORIS <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample13" role="button" aria-expanded="false" aria-controls="collapseExample13">
    Figshare<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample13">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://figshare.com" target="_blank">
        <b>Visit Figshare <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample14" role="button" aria-expanded="false" aria-controls="collapseExample14">
    Zenodo<i class="bi bi-chevron-double-down"></i>
  </button>
  <div class="collapse" id="collapseExample14">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://zenodo.org/" target="_blank">
        <b>Visit Zenodo <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
...
<div class="mb-3">
  <button class="btn btn-round btn-expandable" data-bs-toggle="collapse" href="#collapseExample15" role="button" aria-expanded="false" aria-controls="collapseExample15">
    EUDAT B2SHARE<i class="bi bi-chevron-double-down"></i>
  </button>
  ...
  <div class="collapse" id="collapseExample15">
    <div class="card card-body">
      ...
      <br>
      <a class="link-teal" href="https://eudat.eu/service-catalogue/b2share-0" target="_blank">
        <b>Visit EUDAT B2SHARE <i class="bi bi-box-arrow-up-right"></i></b>
      </a>
    </div>
  </div>
</div>
