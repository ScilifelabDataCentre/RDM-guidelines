  ...
  <div class="card card-body">
    <span>
        <ul>
            ...
            <li>After logging in, you will see the landing page (shown below) that includes multiple options for completing your submission. </li>
            ...
            <br>
            <li> <b>Note:</b> If you have an annotated assembly, fill also the <b>locus tag</b> field, e.g. with an abbreviation of the scientific name of the species.</li>
            <li>Click <b>Submit</b>. A pop-up window will appear, check that the submission was successful by reading the content of the window, copy the accession number (starting with PRJEB...) and add it to your metadata template for future reference, then click <b>Close</b>.</li>
        </ul>
    </span>
  </div>
  <br>
  ...
  <div class="card card-body">
    <span>
        <ul>
            ...
            <li>Create the metadata .xml, <a href="/files/ena_tutorial/Alectoris-graeca-samples.xml">Alectoris-graeca-samples.xml</a>, for the 4 samples.</li>
  ...
  <div class="card card-body">
    <span>
        <ul>
            ...
            <li>2 metadata .xml files are needed in order to submit raw reads, one for the experiments and one for the runs.</li>
  ...
  <div class="card card-body">
    <span>
        <ul>
            ...
            <li>Create a <a href="/files/ena_tutorial/submission-umbrella.xml">submission-umbrella.xml</a>, with the ADD action and an <a href="/files/ena_tutorial/umbrella.xml">umbrella.xml</a> where the 2 studies (one for the raw reads and one for the assembly) are added as children.</li>
  ...
  <div class="card card-body">
    <span>
        <ul>
            ...
            <li><b>Metadata</b> - Description of the data that gives, at a minimum, sufficient information to reproduce the data collection method (e.g. description of how the source material was obtained and details about the sequencing process, such as library preparation and the instruments used).</li> 
        </ul>
    </span>
  </div>  
  <br>
