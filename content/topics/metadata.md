...
* [FAANG sample metadata specification](https://doi.org/10.25504/FAIRsharing.J1aPiC):
...
* [FAANG experimental metadata specification](https://doi.org/10.25504/FAIRsharing.fztr98):
...
For a curated list of relevant standards see [FAIRsharing](https://fairsharing.org) using the query ’[proteomics](https://fairsharing.org/search/?q=proteomics&fairsharingRegistry=Standard&page=1&status=ready)’
